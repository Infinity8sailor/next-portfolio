...
const MusicAi = (props: Props) => {
  return (
    <div id="Music_Ai" className="flex flex-col gap-1 justify-center">
      <div className="flex flex-col lg:flex-row w-full mt-10">
        <div className="w-full lg:w-[50%]">
          <img
            src="./assets/MusicAi_2.png"
      ...
      <div className="w-full my-10 flex justify-center ">
        <img className="rounded-md lg:w-[80%]" src="./assets/musicAi_workflow.png" />
      </div>
      {/* <div className="flex items-center w-full min-h-screen h-fit flex-col  relative">
        <div className="h-screen w-full m-20">
          <iframe
            ...
            width="100%"
            height="100%"
            src="https://whimsical.com/embed/HAqiiHGqaorsYdDpMfBqcD"
          ></iframe>
        </div>
      </div> */}
    </div>
