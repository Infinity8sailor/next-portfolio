      ...
      <div className="container m-auto grid grid-cols-4 auto-rows-min gap-x-2 gap-y-5">
        ...
        <div className="tile col-span-4 lg:col-span-1 col-start-1 lg:row-span-2 px-2">
          <div className="sticky top-[200px]">
            <div className="w-full mx-auto relative bg-white text-center dark:bg-[#444444] px-6 rounded-[20px] mt-[200px]">
              <img
                alt="avatar"
        ...
        {/* {/* <!-- About Me --> */}
        <div className="bg-white dark:bg-[#303030] col-start-1 lg:col-start-2 col-span-4 lg:col-span-3 mt-5 mx-2 px-3 rounded-lg z-10">
